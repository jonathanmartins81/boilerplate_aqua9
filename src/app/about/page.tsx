  ...
  return (
    <>
      ...
      <DynamicSEO
        ...
        description='Conheça mais sobre o Boilerplate Aqua9, desenvolvido por Jonathan Simão. Template profissional para projetos Next.js com TypeScript, Tailwind CSS e SEO otimizado.'
        keywords={[
          'sobre',
          'aqua9',
          'jonathan simão',
